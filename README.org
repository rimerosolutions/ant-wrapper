...
[[https://travis-ci.org/rimerosolutions/ant-wrapper][travis.ci build status page]] [[https://travis-ci.org/rimerosolutions/ant-wrapper.png]]
...
You can [[https://oss.sonatype.org/content/repositories/snapshots/com/rimerosolutions/ant/ant-wrapper/0.0.1-SNAPSHOT/ant-wrapper-0.0.1-SNAPSHOT.jar][download directly]] the wrapper jar file from Sonatype Maven repositories.
